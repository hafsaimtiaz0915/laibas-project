        ...
        <section className="py-24 bg-brand-900 text-white overflow-hidden relative">
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button className="px-8 py-4 bg-white text-brand-900 rounded-full font-semibold text-lg hover:bg-brand-50 transition-all shadow-lg hover:shadow-xl flex items-center gap-2">
                Start Free Trial <ArrowRight className="w-5 h-5" />
              </button>
              <button className="px-8 py-4 bg-transparent border border-brand-200 text-white rounded-full font-semibold text-lg hover:bg-white/10 transition-all">
                Book a Demo
              </button>
            </div>
