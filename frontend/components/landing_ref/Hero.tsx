        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 max-w-2xl animate-fade-in-up">
            <p className="text-xs uppercase tracking-[0.2em] text-slate-500 mb-4">
              Dubai Off-Plan Returns Predictor
            </p>
            <h1 className="text-5xl sm:text-5xl md:text-6xl lg:text-7xl font-serif font-medium text-slate-900 leading-[1.35] mb-6">
              Show buyers predicted returns <br />
              <span className="text-brand-600 italic">for any Dubai off-plan unit</span>
            </h1>

            <p className="text-lg md:text-xl text-slate-600 mb-8 leading-relaxed max-w-xl">
              Select the project and unit type. Proprly estimates projected uplift, yield, and value at handover - with a
              confidence range and the drivers behind the forecast - then generates a buyer-ready PDF in one click.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <Link
                href="/login"
                className="px-8 py-4 bg-slate-900 text-white rounded-full font-semibold text-lg hover:bg-slate-800 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 active:scale-95"
              >
            ...
            <div className="relative z-10 bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden transform rotate-1 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="p-6 bg-slate-50/50 min-h-[350px] md:min-h-[400px] flex flex-col gap-6">
                ...
                <div className="flex gap-4">
                  <div className="w-8 h-8 rounded-full bg-brand-600 flex-shrink-0 flex items-center justify-center text-white font-bold text-xs hidden sm:flex">
                    P
                  </div>
                  <div className="bg-white border border-slate-100 px-4 md:px-6 py-5 rounded-2xl rounded-tl-sm w-full shadow-sm">
                    ...
                    <div className="bg-brand-50 rounded-lg p-3 text-xs text-brand-800 leading-relaxed mb-4">
                      <strong>Forecast Driver:</strong> Strong area momentum in JVC (+18% YoY) and moderate supply
                      pipeline.
                    </div>
