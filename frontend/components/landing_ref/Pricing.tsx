    ...
    <section id="pricing" className="py-16 md:py-24 bg-slate-50 border-t border-slate-200">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl font-serif font-medium text-slate-900 mb-4">Simple, transparent pricing</h2>
          <p className="text-slate-600">Choose the plan that fits your deal flow.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <Link
              href="/login"
              className="block w-full py-3 border-2 border-slate-900 text-slate-900 font-bold rounded-xl hover:bg-slate-50 transition-colors text-center"
            >
              Start Trial
            </Link>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 border-2 border-brand-600 shadow-xl relative transform md:-translate-y-4 order-first md:order-none">
            ...
            <Link
              href="/login"
              className="block w-full py-3 bg-brand-600 text-white font-bold rounded-xl hover:bg-brand-700 transition-colors shadow-lg shadow-brand-200 text-center"
            >
              Get Started
            </Link>
          </div>
